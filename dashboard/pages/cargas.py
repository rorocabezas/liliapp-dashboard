...
# --- ORQUESTADOR 1: Órdenes (Modelo Normalizado) ---
...
# --- ORQUESTADOR 2: Órdenes (Modelo Desnormalizado - Customer Centric) ---
...
# --- ORQUESTADOR 3: Servicios (Modelo Normalizado) ---
...
# --- ORQUESTADOR 4: Servicios (Modelo Híbrido) ---
...
with st.form("etl_runner_form"):
    ...
    if st.form_submit_button("🚀 Iniciar Proceso de Carga", use_container_width=True, type="primary"):
        ...
        # Lógica de enrutamiento para llamar al orquestador correcto
        if etl_process == "Órdenes (Modelo Normalizado: users/profiles)":
